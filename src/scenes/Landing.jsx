...
const Landing = ({setSelectedPage}) => {
  const isAboveLarge = useMediaQuery("(min-width: 1060px)");
    return (
    <section id="home"
      className="md:flex md:justify-between md:items-center gap-16 md:h-full py-10 h-screen mx-auto">
        {/* IMAGE SECTION */}
          ...
          >
            ...
            <p className="mt-10 mb-7 text-sm text-center md:text-start">
              Lorem ipsum dolor sit amet consectetur adipisicing elit.
               Veritatis suscipit nisi accusamus molestiae fugiat
                corporis, fuga illo? Molestias, officia!
            </p>
          </motion.div>
